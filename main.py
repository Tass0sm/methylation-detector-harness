...
# fpr_arr, tpr_arr, thresholds = metrics.roc_curve(y_test, y_pred)
...
# fig.savefig("m6anet_roc.png")


# fig, ax = plt.subplots(1, 1)

# precision_arr, recall_arr, thresholds = metrics.precision_recall_curve(y_test, y_pred)
...
# fig.savefig("m6anet_pr.png")


# # m6anet.interface.run(X_test, y_test)
