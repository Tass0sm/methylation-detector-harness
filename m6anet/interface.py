...
import subprocess
import pandas as pd
# sys.path.insert(0, "/users/PAS1405/tassosm/Work/roc-curve-stuff/m6anet/m6anet/m6anet")
...
def copy_needed_reads(read_dir1, read_dir2, X_test, work_dir):
    ...
    copy_reads_script_path = "/users/PAS1405/tassosm/Work/roc-curve-stuff/m6anet/copy_reads.sh"
...
def prepare(read_dir1, read_dir2, X_test, name):
    work_dir = os.path.join("/users/PAS1405/tassosm/Work/roc-curve-stuff/m6anet", name)
